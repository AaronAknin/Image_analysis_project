# -*- coding: utf-8 -*-
"""ama2351_wy2374_wz2550_IrisRecognition.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GFrD1TPpyDnVnVznNNtIllo0Ik_t2bgl
...
We did data preprocessing by applying localization, normalization, enhancement and feature extraction on the data. Then, we used IrisMatching to get the prediction of the training data. We use PerformanceEvaluation to get the (CRR)correct recognition rate of 3 distance measurement methods and 7 different dimension. At the end, we draw the table of recognition results by using different distance measurement methods, and found that ... By plotting the CRR of using feature vectors of different dimension, we found that... We used 10 threshhold numbers for matching and got different false match rate and false nonmatch rate. Among these 10 threshhold numbers, all threshholds below 0.42 gives the 0 false match rate and xx gives the smallest false nonmatch rate. By plotting the ROC curve, we found that xx gives the best result.
---
